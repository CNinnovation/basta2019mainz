...
namespace GenericViewModels.Services
{
    public class MessageService : IMessageService
    {
        ...
        internal class Subscriber
        {
            ...
            private Dictionary<Type, Subscriptions> _subscriptions = new Dictionary<Type, Subscriptions>();
        ...
        {
            private Dictionary<Type, Delegate> _subscriptions = new Dictionary<Type, Delegate>();
